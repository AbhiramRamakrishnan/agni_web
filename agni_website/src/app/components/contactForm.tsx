...
// const PROFILE_PHOTO = '/AGNI Logos & Badges.pdf.svg'; // Make sure this path is correct
...
//     >
//       <div
//         className="bg-white border border-gray-100 rounded-2xl shadow-xl p-6 md:p-8"
...
//         >
//           We specialize in digital transformation and cutting-edge software development.
//           With over <strong className="text-black font-medium">8+ years</strong> of experience,
//           we’ve delivered <strong className="text-black font-medium">200+</strong> projects in e-commerce, fintech, healthcare, and more.
//         </motion.p>
//       </div>
//     </motion.div>
//   );
...
//       <div className="fixed inset-0 z-0 pointer-events-none transition-transform duration-200" ref={bgRef}>
//         <svg width="100%" height="100%" viewBox="0 0 900 1000" fill="none" className="opacity-10">
//           {Array.from({ length: 48 }).map((_, row) =>
//             Array.from({ length: 24 }).map((_, col) => (
//               <circle
//                 key={`${row}-${col}`}
//                 cx={20 + 36 * col + (row % 2 ? 14 : 0)}
//                 cy={20 + 36 * row}
//                 r="4"
//                 fill={PRIMARY}
//               />
...
//       {/* 📨 Contact Section */}
//       <section className="relative z-10 w-full px-4 sm:px-6 py-20 bg-white min-h-[100vh]">
...
//                 <select name="state" required className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0f9952] text-gray-800 font-medium">
...
//                 </select>
//                 <textarea name="details" rows={5} placeholder="Project Details" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0f9952] text-gray-800 font-medium" />
//                 <button type="submit" className="w-full bg-[#0f9952] hover:bg-[#0c7f44] text-white py-3 px-6 rounded-lg font-bold text-lg shadow">
//                   💬 Send Message
//                 </button>
