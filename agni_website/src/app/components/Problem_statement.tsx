...
//   // Autoplay functionality for desktop only
//   useEffect(() => {
...
//   return (
//     <section className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-8 sm:py-12 lg:py-20">
...
//         {/* Mobile Layout (< lg) - Scrollable Cards */}
...
//                   <div key={index} className="flex-[0_0_280px] sm:flex-[0_0_320px] min-w-0">
//                     <motion.div
...
//         {/* Desktop Layout (>= lg) - With Navigation Buttons */}
...
//                 <div className="flex">
//                   {slides.map((slide, index) => (
//                     <div key={index} className="flex-[0_0_100%] min-w-0 px-3 xl:px-4">
//                       <motion.div
...
//                               <motion.h3 
//                                 className="text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold text-gray-900 mb-4 lg:mb-5 xl:mb-6 leading-tight"
...
//                               </motion.h3>
//                               <motion.p 
//                                 className="text-gray-700 text-base lg:text-lg xl:text-xl leading-relaxed"
//                                 initial={{ opacity: 0, x: 20 }}
//                                 animate={{ opacity: 1, x: 0 }}
