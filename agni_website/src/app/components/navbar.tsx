...
// // Inside your Navbar component (remove the previous logoSrc declaration)
// const logoSrc = isScrolled ? '/Primary Logo (Improved).svg' : '/Secondary_Logo.svg';
...
const Navbar = () => {
  ...
  const logoSrc = isScrolled ? '/Primary Logo (Improved).svg' : '/Secondary Logo.svg';
